...
class SCP
{
    ...
    /**#@+
     * @access private
     * @see \sftp\Net\SCP::_send()
     * @see \sftp\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * By default, \sftp\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \sftp\Net\SCP::get(), you will get a file, twelve bytes
