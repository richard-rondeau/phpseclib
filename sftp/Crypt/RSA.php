...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \sftp\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \sftp\Crypt\RSA::createKey()
     * @see \sftp\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \sftp\Crypt\RSA::createKey()
     * @see \sftp\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     * An array containing two \sftp\Math\BigInteger objects.
     *
     ...
     * @access private
     */
    var $comment = 'sftp-generated-key';

    /**
     * The constructor
     *
     * If you want to make use of the openssl extension, you'll need to set the mode manually, yourself.  The reason
     * \sftp\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \sftp\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \sftp\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
     ...
     * exponent this won't work unless you manually add the public exponent. sftp tries to guess if the key being used
     ...
     *
     * If sftp guessed a private key was a public key and loaded it as such it might be desirable to force
     * sftp to treat the key as a private key. This function will do that.
     *
     * Do note that when a new key is loaded the index will be cleared.
     *
     * Returns true on success, false on failure
    ...
    {
        // \sftp\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \sftp\Crypt\RSA may not decrypt
