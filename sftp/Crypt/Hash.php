...
class Hash
{
    /**#@+
     * @access private
     * @see \sftp\Crypt\Hash::__construct()
     */
    /**
    ...
    function _sha512($m)
    {
        ...
        // Produce the final hash value (big-endian)
        // (\sftp\Crypt\Hash::hash() trims the output for hashes but not for HMACs.  as such, we trim the output here)
